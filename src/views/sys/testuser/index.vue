<template>
	...
	<el-card>
		<el-space>
			<el-space>
				<el-button icon="Plus" type="primary" @click="addHandle()">新增</el-button>
			</el-space>
		</el-space>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table">
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="200">
				<template #default="scope">
					<el-button type="primary" link @click="updateHandle(scope.row)">编辑</el-button>
				</template>
			</el-table-column>
		</el-table>
		<el-pagination
		...
		<Add ref="addRef" @refresh-data-list="getDataList"></Add>
...
const queryRef = ref()
const updateRef = ref()
const updateHandle = (value: Record<string, any>) => {
	updateRef.value.init(value)
}

const addRef = ref()
const addHandle = (id?: number) => {
	addRef.value.init(id)
}
</script>
